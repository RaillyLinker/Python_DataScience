...
def main():
    ...
    tu.train_model(
        ...
        check_point_file_save_directory_path="../_by_product_files/check_point_files/multi_layer_perceptron_for_mnist_nn",
        # check_point_load_file_full_path="../_by_product_files/check_point_files/~/checkpoint(2024_02_29_17_51_09_330).pt",
        log_freq=1
    )

    # 모델 저장
    model_file_save_directory_path = "../_by_product_files/torch_model_files/multi_layer_perceptron_for_mnist_nn"
